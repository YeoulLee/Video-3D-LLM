...
# Usage: sh scripts/3d/eval/eval_sqa3d_lora.sh <ckpt_dir_under_./ckpt> <frame_sampling_strategy> <max_frame_num>
# Example: sh scripts/3d/eval/eval_sqa3d_lora.sh llavanext-qwen-video3dllm-sqa3d-lora uniform 32
